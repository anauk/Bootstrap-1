...
import Slide_1 from "../img/phone1.jpg";
import Slide_2 from "../img/phone2.jpg";
...
//создает новый массив из слайдов не зависимо от их количества
    renderSlides() {
    ...
    //создает новый массив точек в зависимости от количества слайдов
    renderDots(){
        return this.state.slides.map((item, index)=>(
            <li
